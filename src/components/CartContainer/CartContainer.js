...
export const CartContainer = ()=>{
    ...
    const sendOrder = (evt)=>{
        ...
        const queryRef = collection(bd,"orders");
    ...
    const updateProduct = ()=>{
        ...
        const queryRef = doc(bd,"Productos","DIgN4eVQTElBvaRydJKP");
        //actualizamos el documento
        updateDoc(queryRef,{price:2300}).then(()=>console.log("actualizado correctamente")).catch((error)=>console.log("hubo un error"))
    }
